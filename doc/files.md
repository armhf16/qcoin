...
* qcoin.conf: contains configuration settings for qcoind or qcoin-qt
* qcoind.pid: stores the process id of qcoind while running
...
* debug.log: contains debug information and general logging generated by qcoind or qcoin-qt
