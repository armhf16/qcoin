...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s qcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  qcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded qcoin transaction") + "\n" +
              "  qcoin-tx [options] -create [commands]   " + _("Create hex-encoded qcoin transaction") + "\n" +
              "\n";
